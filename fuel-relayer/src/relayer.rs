...
use crate::{log::EthEventLog, pending_queue::PendingQueue, validators::Validators, Config};
use futures::Future;
...
impl Relayer {
        ...
        P: Middleware<Error = ProviderError> + 'static,
    {
        ...
        info!("Initial syncing finished on block {best_block}. Continue to active sync.",);
