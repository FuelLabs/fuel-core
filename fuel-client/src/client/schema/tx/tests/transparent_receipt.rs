...
impl TryFrom<Receipt> for fuel_vm::prelude::Receipt {
    ...
    fn try_from(schema: Receipt) -> Result<Self, Self::Error> {
        Ok(match schema.receipt_type {
            ...
            ReceiptType::Return => {
                fuel_vm::prelude::Receipt::Return {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::ReturnData => {
                fuel_vm::prelude::Receipt::ReturnData {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::Revert => {
                fuel_vm::prelude::Receipt::Revert {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::LogData => {
                fuel_vm::prelude::Receipt::LogData {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::Transfer => {
                fuel_vm::prelude::Receipt::Transfer {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::TransferOut => {
                fuel_vm::prelude::Receipt::TransferOut {
                    id: schema
                        .contract
                        .ok_or_else(|| MissingField("contract".to_string()))?
                        .id
            ...
            ReceiptType::ScriptResult => {
                fuel_vm::prelude::Receipt::ScriptResult {
                    result: Word::from(
                        schema
                            .result
