...
impl Coins {
    ...
    pub fn coin_id(&self) -> CoinId {
        match self {
            ...
            Coins::MessageCoin(coin) => CoinId::Message(coin.nonce),
        }
    }
    ...
    pub fn owner(&self) -> &Address {
        match self {
            ...
            Coins::MessageCoin(coin) => &coin.recipient,
        }
    }
    ...
    pub fn amount(&self) -> Word {
        match self {
            ...
            Coins::MessageCoin(coin) => coin.amount,
        }
    }
    ...
    pub fn asset_id(&self) -> &AssetId {
        match self {
            ...
            Coins::MessageCoin(_) => &AssetId::BASE,
        }
    }
}
...
impl From<MessageCoin> for Coins {
    fn from(coin: MessageCoin) -> Self {
        Coins::MessageCoin(coin)
    }
}
