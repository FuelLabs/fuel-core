...
use fuel_core_types::{
    blockchain::{SealedBlockHeader, consensus::Genesis},
    fuel_tx::{Bytes64, TxId},
    fuel_types::BlockHeight,
    services::p2p::{
        DelegatePublicKey, GossipData, NetworkableTransactionPool,
        PreConfirmationMessage, ProtocolSignature, Transactions,
    },
};
use std::ops::Range;
