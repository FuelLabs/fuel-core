...
fn initialize_topic_score_params(topic_weight: f64) -> TopicScoreParams {
    ...
    params.first_message_deliveries_decay =
        score_parameter_decay(EPOCH.saturating_mul(100));
    ...
    params.invalid_message_deliveries_decay =
        score_parameter_decay(EPOCH.saturating_mul(50));
...
fn initialize_peer_score_params(thresholds: &PeerScoreThresholds) -> PeerScoreParams {
    let mut params = PeerScoreParams {
        ...
        retain_score: EPOCH.saturating_mul(100),
        app_specific_weight: 0.0,
        ip_colocation_factor_threshold: 8.0, // Allow up to 8 nodes per IP
        behaviour_penalty_threshold: 6.0,
        behaviour_penalty_decay: score_parameter_decay(EPOCH.saturating_mul(10)),
        ..Default::default()
    };
