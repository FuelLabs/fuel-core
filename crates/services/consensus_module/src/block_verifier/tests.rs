...
#[test_case(
    {
        ...
        h.consensus_mut().prev_root = Bytes32::zeroed();
        h.consensus_mut().time = Tai64::UNIX_EPOCH;
        h.consensus_mut().height = 0u32.into();
        h
    },
...
#[test_case(
    {
        ...
        h.consensus_mut().prev_root = Bytes32::zeroed();
        h.consensus_mut().time = Tai64::UNIX_EPOCH;
        h.consensus_mut().height = 113u32.into();
        h
    },
...
#[test_case(
    {
        ...
        h.consensus_mut().prev_root = Bytes32::zeroed();
        h.consensus_mut().time = Tai64::UNIX_EPOCH;
        h.consensus_mut().height = 5u32.into();
        h
    },
...
#[test_case(
    {
        let mut h = BlockHeader::default();
        h.consensus_mut().prev_root = Bytes32::from([1u8; 32]);
        h.consensus_mut().time = Tai64::UNIX_EPOCH;
        h.consensus_mut().height = 0u32.into();
        h
    },
