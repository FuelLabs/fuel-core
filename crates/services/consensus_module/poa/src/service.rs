...
impl SharedState {
    ...
    /// Whether PoA considers this node synced with the network and ready to
    /// produce. Owned here so probes and production gating share one source
    /// of truth (see `SyncTask`).
