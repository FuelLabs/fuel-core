...
pub fn verify_block_fields<D: Database>(
    ...
    //  But we do the same in the executor right now during validation mode. I will not
    // check  it for now. But after merge of the https://github.com/FuelLabs/fuel-core/pull/889 it
