    ...
    pub fn local_node_with_reader(snapshot_reader: SnapshotReader) -> Self {
        ...
        Self {
            graphql_config: GraphQLConfig {
                ...
                block_subscriptions_queue: DEFAULT_BLOCK_SUBSCRIPTIONS_QUEUE,
                max_queries_depth: DEFAULT_MAX_QUERIES_DEPTH,
                max_queries_complexity: DEFAULT_MAX_QUERIES_COMPLEXITY,
                max_queries_recursive_depth: DEFAULT_MAX_QUERIES_RECURSIVE_DEPTH,
                max_queries_resolver_recursive_depth:
                    DEFAULT_MAX_QUERIES_RESOLVER_RECURSIVE_DEPTH,
                max_queries_directives: DEFAULT_MAX_QUERIES_DIRECTIVES,
                max_concurrent_queries: DEFAULT_MAX_CONCURRENT_QUERIES,
                request_body_bytes_limit: DEFAULT_REQUEST_BODY_BYTES_LIMIT,
                query_log_threshold_time: DEFAULT_QUERY_LOG_THRESHOLD_TIME,
                api_request_timeout: DEFAULT_API_REQUEST_TIMEOUT,
                assemble_tx_dry_run_limit: DEFAULT_ASSEMBLE_TX_DRY_RUN_LIMIT,
