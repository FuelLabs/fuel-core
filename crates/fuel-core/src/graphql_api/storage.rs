...
pub enum Column {
    ...
    CoinsToSpend = 26,
    /// See [`DaCompressionTemporalRegistryAddressV2`](da_compression::fault_proving_extra_storage::address::DaCompressionTemporalRegistryAddressV2)
    ...
    // See [`DaCompressionTemporalRegistryAssetIdV2`](da_compression::fault_proving_extra_storage::asset_id::DaCompressionTemporalRegistryAssetIdV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryContractIdV2`](da_compression::fault_proving_extra_storage::contract_id::DaCompressionTemporalRegistryContractIdV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryScriptCodeV2`](da_compression::fault_proving_extra_storage::script_code::DaCompressionTemporalRegistryScriptCodeV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryPredicateCodeV2`](da_compression::fault_proving_extra_storage::predicate_code::DaCompressionTemporalRegistryPredicateCodeV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryIndexV2`](da_compression::fault_proving_extra_storage::registry_index::DaCompressionTemporalRegistryIndexV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryTimestampsV2`](da_compression::fault_proving_extra_storage::timestamps::DaCompressionTemporalRegistryTimestampsV2)
    #[cfg(feature = "fault-proving")]
    ...
    /// See [`DaCompressionTemporalRegistryEvictorCacheV2`](da_compression::fault_proving_extra_storage::evictor_cache::DaCompressionTemporalRegistryEvictorCacheV2)
    #[cfg(feature = "fault-proving")]
