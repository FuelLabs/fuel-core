...
pub struct DepositCoin(pub(crate) DepositCoinModel);
...
/// The schema analog of the [`coins::Coins`].
        ...
        let coins = random_improve(db, &spend_query)?
            ...
            .map(|coins| {
                coins
                    .into_iter()
                    .map(|coin| match coin {
                        coins::Coins::Coin(coin) => Coins::Coin(coin.into()),
                        coins::Coins::DepositCoin(coin) => {
                            Coins::DepositCoin(coin.into())
                        }
                    })
                    .collect_vec()
            })
...
impl From<DepositCoinModel> for DepositCoin {
    fn from(value: DepositCoinModel) -> Self {
        DepositCoin(value)
    }
}

impl From<coins::Coins> for Coins {
    fn from(value: coins::Coins) -> Self {
        match value {
            coins::Coins::Coin(coin) => Coins::Coin(coin.into()),
            coins::Coins::DepositCoin(coin) => Coins::DepositCoin(coin.into()),
        }
    }
}
