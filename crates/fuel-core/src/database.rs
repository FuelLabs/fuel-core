...
pub type OnChainKeyValueView =
    KeyValueView<ColumnType<OnChain>, HeightType<OnChain>>;
pub type OnChainIterableKeyValueView =
    IterableKeyValueView<ColumnType<OnChain>, HeightType<OnChain>>;
pub type OffChainKeyValueView =
    KeyValueView<ColumnType<OffChain>, HeightType<OffChain>>;
