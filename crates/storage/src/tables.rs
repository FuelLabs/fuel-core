...
use fuel_core_types::{
    ...
    entities::{
        coins::coin::CompressedCoin, contract::ContractUtxoInfo,
        relayer::message::Message,
    },
    fuel_tx::{Bytes32, ConsensusParameters, Transaction, TxId, UtxoId},
    fuel_types::{BlockHeight, ContractId, Nonce},
};
pub use fuel_vm_private::storage::{
    BlobData, ContractsAssets, ContractsRawCode, ContractsState, UploadedBytecodes,
};
