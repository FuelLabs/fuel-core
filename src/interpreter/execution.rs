...
impl Interpreter {
    pub fn execute(&mut self, op: Opcode) {
        match op {
            Opcode::Add(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::Div(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_error(
                    ra,
                    Word::div,
                    self.registers[rb],
            ...
            Opcode::Exp(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::MathLog(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_error(
                    ra,
            ...
            Opcode::MathRoot(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_error(
                    ra,
            ...
            Opcode::Mod(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_error(
                    ra,
                    Word::wrapping_rem,
                    self.registers[rb],
            ...
            Opcode::ModI(ra, rb, imm) if Self::is_valid_register_couple_alu(ra, rb) => self
                .alu_error(
                    ra,
                    Word::wrapping_rem,
                    self.registers[rb],
            ...
            Opcode::Move(ra, rb) if Self::is_valid_register_couple_alu(ra, rb) => {
                self.alu_set(ra, self.registers[rb])
            }

            Opcode::Mul(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::SLL(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::SRL(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::Sub(ra, rb, rc) if Self::is_valid_register_triple_alu(ra, rb, rc) => self
                .alu_overflow(
                    ra,
            ...
            Opcode::Malloc(ra)
                if Self::is_valid_register(ra) && self.malloc(self.registers[ra]) => {}
            ...
            // TODO ECRECOVER: Signature recovery
            // TODO KECCAK256: keccak-256
