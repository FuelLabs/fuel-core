...
// struct Scripts {
//     inputs_to_outputs: InputToOutput,
//     script_size: usize,
...
//             },
//         ];
//         for inputs_to_outputs in inputs {
//             measure::<2, 2, 0>(
//                 Inputs {
//                     scripts: Scripts {
//                         inputs_to_outputs,
...
//                 coin_to_change,
//                 coin_to_variable,
//                 coin_to_contract_created,
//                 message_to_void,
//                 message_to_coin,
//                 message_to_change,
//                 message_to_variable,
//                 message_to_contract_created,
//                 contract_to_contract,
//                 void_to_message,
//                 void_to_coin,
//                 void_to_change,
//                 void_to_variable,
//                 void_contract_created,
//             },
//         script_size,
//         script_data_size,
//         message_data_size,
...
//     let mut output_coins = output_coins::<{ u64::MAX }>().cycle();
...
//         create_inputs_for_coins(&mut coins, &mut script_inputs, coin_to_void);
//         create_inputs_for_messages(&mut messages, &mut script_inputs, message_to_void);
...
//         let outputs = output_coins.by_ref().take(void_to_coin).collect();
