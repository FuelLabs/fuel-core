...
create table test_namespace.thing (
    id bigint primary key,
    account varchar(66) not null,
    object bytea not null
);

create table test_namespace.thing2 (
    id bigint primary key,
    account varchar(66) not null,
...
values
    (cast(x'B2BB8366E42C8896' as bigint), 'test_namespace', 'thing'),
    (cast(x'D5571E9C13557615' as bigint), 'test_namespace', 'thing2');
