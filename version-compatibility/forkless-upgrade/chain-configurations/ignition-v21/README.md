...
This configuration is based on the `ignition-testnet` consensus parameters from
`chain-configuration/upgradelog/ignition-testnet/consensus_parameters/21.json`.
